...
"""Test the theory leg's closed form against the measured AUCs.
    ...
    nice -n 19 .venv/bin/python research/factory/theory_auc_check.py

SIGN_IDENTIFIABILITY_THEORY.md derives, for one centred feature with
...
OUT = ROOT / "research" / "factory" / "logs" / "theory_auc_check.md"
...
def main():
    ...
    lines += [
        ...
        "research/factory/theory_auc_check.py`",
    ]
    OUT.write_text("\n".join(lines) + "\n")
    print("\n".join(lines))
    return 0
