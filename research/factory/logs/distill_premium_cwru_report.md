...
- cost: 0.113 ms/window (5 programs)

## premium families (cost-receipted champion rule)
- rqa: base 0.914 -> augmented 0.980 (paired +0.066, 95% CI [+0.033, +0.106]) — **INCLUDED**
  cost: 66.03 ms/window vs base 0.113 ms/window (~585x); O(n^2) recurrence matrix per window (~200x the base grammar)
