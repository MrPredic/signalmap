...
separation metric.
    ...
    nice -n 19 .venv/bin/python study/tools/sign_identifiability_readout.py

Prereg: study/PREREG.md (frozen, git 8c303c6).
Banks: data/signdomains/<domain>/, built to study/BANK_CONTRACT.md by people
...
M2 (theory) lives in study/THEORY.md; M4 (sign transfer across
...
def main(argv=None):
    ...
    lines += [
        ...
        "study/tools/sign_identifiability_readout.py --refresh`",
